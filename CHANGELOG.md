...
- 6 shape families (Bloom, Silk, Flare, Nova, Void, Jade) × 40 palette presets
...
- Core `createAvatar` API, optional React component (`@oreo-ui/avatar/react`), and `oreo-avatar` CLI
